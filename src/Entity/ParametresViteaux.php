...
class ParametresViteaux
{
    ...
    #[Assert\Range(
        min: 0,
        max: 120,
        notInRangeMessage: "L'âge est invalide."
    )]   
    ...
    #[Assert\Range(
        min: 50,
        max: 180,
        notInRangeMessage: "La fréquence cardiaque doit être entre {{ min }} et {{ max }}."
    )]
    private ?int $fc = null;
    ...
    #[Assert\Range(
        min: 12,
        max: 30,
        notInRangeMessage: "La fréquence respiratoire doit être entre {{ min }} et {{ max }}."
    )]   
    private ?int $fr = null;
    ...
    #[Assert\Length(
        max: 255,
        maxMessage: "L'ECG ne peut pas dépasser {{ limit }} caractères." )]
        #[Assert\Range(
            min: 3,
            max: 15,
            notInRangeMessage: "L'ECG doit être entre {{ min }} et {{ max }}."
        )]       
    ...
    #[Assert\Range(
        min: 80,
        max: 200,
        notInRangeMessage: "La pression artérielle systolique doit être entre {{ min }} et {{ max }}."
    )]   
    ...
    #[Assert\Range(
        min: 80,
        max: 200,
        notInRangeMessage: "La pression artérielle diastolique doit être entre {{ min }} et {{ max }}."
    )]
    ...
    #[Assert\Range(
        min: 0,
        max: 100,
        notInRangeMessage: "Le SpO2 doit être compris entre {{ min }} et {{ max }}."
    )]
