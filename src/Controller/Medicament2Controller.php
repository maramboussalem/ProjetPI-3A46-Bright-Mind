...
final class Medicament2Controller extends AbstractController
{
    ...
    #[Route('/new', name: 'app_medicament2_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager, MedicamentRepository $medicamentRepository, ValidatorInterface $validator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_medicament2_index2', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_medicament2_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_medicament2_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_medicament2_delete', methods: ['POST'])]
