...
final class DisponibiliteController extends AbstractController
{
    ...
    #[Route('/Me', name: 'app_disponibiliteM_index', methods: ['GET'])]
    public function indexM(DisponibiliteRepository $disponibiliteRepository): Response
    {
        return $this->render('disponibilite/indexM.html.twig', [
            'disponibilites' => $disponibiliteRepository->findAll(),
        ]);
    }
